    ...
    <div class="col-xl-12">
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header">
                ...
                @include('dashboard.cities.createModal')
            </div>
            <div class="card-body">
                <!--begin::Table-->
                            ...
                            <table class="table table-bordered city-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left" scope="col">جوي</th>
                                        <th class="text-left" scope="col">بري</th>
...
<script>
    ...
    <script type="text/javascript">
        ...
        var table = $('.city-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('index_cities') }}",
            columns: [
                { data: 'DT_RowIndex', 'orderable': false, 'searchable': false },
                {data: 'id', name: 'id'},
                {data: 'name', name: 'name', orderable: true, searchable: true},
                {data: 'hotel_count', name: 'hotel_count', orderable: true, searchable: true},
                {data: 'background', name: 'background', orderable: true, searchable: true},
                {data: 'bg_img_train', name: 'bg_img_train', orderable: true, searchable: true},
