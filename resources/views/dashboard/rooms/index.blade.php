...
@section('title') الغرف @endsection
@section('css')
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">الغرف</h3>
                </div>
                @include('dashboard.rooms.createModal')
            </div>
            <div class="card-body">
                <!--begin::Table-->
                            ...
                            <table class="table table-bordered room-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left" scope="col">الغرفه</th>
