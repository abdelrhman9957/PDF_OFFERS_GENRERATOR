...
@section('title') الوجبات @endsection
@section('css')
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">الوجبات</h3>
                </div>
                @include('dashboard.meals.createModal')
            </div>
            <div class="card-body">
                <!--begin::Table-->
                            ...
                            <table class="table table-bordered meals-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left" scope="col">الوجبه</th>
